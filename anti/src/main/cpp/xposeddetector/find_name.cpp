...
char *find_name::findField(C_JNIEnv *env, jobject clazz, int staticFlag, jclass type) {
    ...
    jmethodID getDeclaredFields = (*env)->GetMethodID((JNIEnv *) env, classClass, "getDeclaredFields", "()[Ljava/lang/reflect/Field;");
    ...
    jmethodID getType = (*env)->GetMethodID((JNIEnv *) env, classField, "getType", "()Ljava/lang/Class;");
    jmethodID getName = (*env)->GetMethodID((JNIEnv *) env, classField, "getName", "()Ljava/lang/String;");
...
char *find_name::findVoidStringName(C_JNIEnv *env, jclass clazz) {
    char *name = nullptr;
    jclass classClass = (*env)->FindClass((JNIEnv *) env, "java/lang/Class");
    jmethodID getDeclaredMethods = (*env)->GetMethodID((JNIEnv *) env, classClass, "getDeclaredMethods", "()[Ljava/lang/reflect/Method;");
    jclass classMethod = (*env)->FindClass((JNIEnv *) env, "java/lang/reflect/Method");
    jmethodID getModifiers = (*env)->GetMethodID((JNIEnv *) env, classMethod, "getModifiers", "()I");
    jmethodID getParameterTypes = (*env)->GetMethodID((JNIEnv *) env, classMethod, "getParameterTypes", "()[Ljava/lang/Class;");
    jmethodID getReturnType = (*env)->GetMethodID((JNIEnv *) env, classMethod, "getReturnType", "()Ljava/lang/Class;");
    jmethodID getName = (*env)->GetMethodID((JNIEnv *) env, classMethod, "getName", "()Ljava/lang/String;");
    ...
    for (int i = 0; i < length; ++i) {
        ...
        if ((modifier & (NATIVE | STATIC)) == STATIC
            ...
            jmethodID methodMethod = (*env)->GetStaticMethodID((JNIEnv *) env, clazz, methodName, "()Ljava/lang/String;");
